var SEPs = [
  ...
  },
  {
    ...
    description: ['ICEP is for Medical-only coverage (MA-only)'],
    timePeriod: [
  ...
  },
  {
    code: 'ICEP (Delayed B)',
    name: 'Initial Coverage Enrollment Period',
    description: ['ICEP is for Medical-only coverage (MA-only), MAPD, PDP'],
    timePeriod: ['Delayed Part B: 3 months prior to effective date'],
    enrollMA: true,
    enrollMAPD: true,
    enrollPDP: false,
  },
